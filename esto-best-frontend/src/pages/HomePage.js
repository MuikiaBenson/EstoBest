            ...
            <div className="flex flex-grow">
                ...
                <nav className="bg-white w-1/5 py-4 px-6 shadow-md">
                    <ul className="space-y-4">
                        ...
                        <li><a href="#" className="text-blue-600 hover:underline">Properties</a></li>
                        <li><a href="#" className="text-blue-600 hover:underline">Maintenance</a></li>
                        ...
                        <li><a href="#" className="text-blue-600 hover:underline">Users</a></li>
                    </ul>
                </nav>
